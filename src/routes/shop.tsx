...
// Map our generic sort to SearchSortKeys (which only supports RELEVANCE and PRICE)
function mapSort(sort: SortValue): { sortKey: string; reverse: boolean } {
  switch (sort) {
    ...
    // search API doesn't support best-selling/created/title sorts directly; fall back to RELEVANCE
