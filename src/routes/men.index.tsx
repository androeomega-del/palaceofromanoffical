 ...
 * verified Shopify handles (mens-clothing / swimwear / mens-shoes /
 * mens-shoes / mens-bags / mens-accessories / mens-accessories /
...
const TRENDING_TILES: { handle: string; label: string; alt: string }[] = [
  { handle: "mens-clothing", label: "Tailoring", alt: "Men's tailoring — unstructured jackets and fluid trousers" },
  ...
  { handle: "mens-shoes", label: "Trainers", alt: "Men's trainers — designer sneakers" },
  { handle: "mens-bags", label: "Bags", alt: "Men's bags — briefcases, totes and weekenders" },
  { handle: "mens-accessories", label: "Sunglasses", alt: "Men's sunglasses — designer eyewear" },
];
...
function BrandSpotlightRail() {
  return (
    ...
    >
      <div className="max-w-screen-md mx-auto px-5 md:px-10 grid grid-cols-2 gap-4 md:gap-10">
...
const OCCASIONS: { label: string; handle: string }[] = [
  { label: "Workwear", handle: "mens-clothing" },
  { label: "Weekend", handle: "mens-clothing" },
  { label: "Evening", handle: "mens-clothing" },
