...
const FAQS: CityFAQ[] = [
  ...
  { q: "What brands do you carry?", a: "Around one hundred maisons — including Versace, Prada, Gucci, Dolce & Gabbana, Bottega Veneta, Brunello Cucinelli, Saint Laurent, Fendi, Tom Ford, Givenchy, Roberto Cavalli, Moncler and more. Browse the full list under Designers A–Z." },
];
