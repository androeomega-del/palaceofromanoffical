...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      ...
      {
        // LocalBusiness — connects the verified Google Business Profile to
        // the domain so Google can reconcile the listing with the site.
        type: "application/ld+json",
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "@id": "https://palaceofromanofficial.com/#localbusiness",
          name: "Palace of Roman",
          url: "https://palaceofromanofficial.com",
          image: "https://palaceofromanofficial.com/brand/logo-wordmark.png",
          logo: "https://palaceofromanofficial.com/brand/logo-wordmark.png",
          ...
          areaServed: { "@type": "Place", name: "Worldwide" },
          hasMap: "https://share.google/CZeLml2jcRi9MtNqP",
          sameAs: [
            "https://share.google/CZeLml2jcRi9MtNqP",
            "https://www.yelp.com/biz/palace-of-roman",
            "https://www.instagram.com/palaceofroman/",
