...
function ProductView({
  ...
  const { contextLinks } = Route.useLoaderData() as { contextLinks: PdpContextLinks };
            ...
            <div className="lg:hidden -mx-6">
              ...
              >
                {(images.length ? images : [{ url: "", altText: product.title }]).map((img, i) => (
                  <div key={i} className="min-w-full snap-center aspect-square bg-[var(--studio-canvas)] overflow-hidden">
                    {img.url && (
                      <button
                        type="button"
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  onClick={handleAdd}
                  aria-busy={isLoading}
                  className="pdp-noir-cta w-full h-14 text-[14px] uppercase inline-flex items-center justify-center gap-2"
                >
                  {isLoading ? (
