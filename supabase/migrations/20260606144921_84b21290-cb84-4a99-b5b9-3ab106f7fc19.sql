...
BEGIN
  ...
  SELECT jobid INTO jid FROM cron.job WHERE jobname = 'abandoned-cart-recovery';
  IF jid IS NOT NULL THEN PERFORM cron.unschedule(jid); END IF;
END $$;
...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    url := 'https://project--a70dea94-4a98-4b06-9d12-c49a8efe251f.lovable.app/api/public/cron/abandoned-cart-recovery',
